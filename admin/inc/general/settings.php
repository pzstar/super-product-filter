    ...
    <form method="POST">
        ...
        <div class="swpf-settings-row">
            <label>
                ...
                <strong><?php esc_html_e('Keep Filtered Results Out of Search Engines', 'super-product-filter'); ?></strong>
            </label>
        ...
        <div class="swpf-settings-row">
            <label>
                ...
                <strong><?php esc_html_e('Theme Compatibility Mode', 'super-product-filter'); ?></strong>
            </label>
