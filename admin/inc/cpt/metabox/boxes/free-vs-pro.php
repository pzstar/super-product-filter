    ...
    <table class="swpf-compare-table">
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Show/Hide Empty Terms %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/hide-filter-attributes-with-no-products/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Basic', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Conditional Filters %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/selective-display-of-attributes/" target="_blank">', '</a>');
                ?>
            </td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Step-by-Step Filtering %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/step-by-step-filter/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Filter Placement %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/shop/" target="_blank">', '</a>');
                ?>
            </td>
            <td><?php esc_html_e('Sidebar / Inline', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Off-Canvas Filters %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/off-canvas-filter/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Auto Apply Filters %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/auto-submit-filter/" target="_blank">', '</a>');
                ?>
            </td>
            <td><?php esc_html_e('Basic', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Open/Close Filters %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/open-close-filter-box/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Fixed Height Filters %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/filter-with-fixed-height/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('AJAX Pagination %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/pagination-paged/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Load More Button %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/pagination-load-more/?paged=1&swpf_filter=1&swpf_filter_sc=8305&pgn_type=more-btn" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Infinite Scroll %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/pagination-infinite-scroll/?paged=1&swpf_filter=1&swpf_filter_sc=8308&pgn_type=infinite" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Shop Builder %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/shop/shop-builder-style-1/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
        ...
        <tr>
            <td class="swpf-feature">
                <?php
                /* translators: 1: Link open, 2: Link close */
                echo sprintf(esc_html__('Custom Shop Layout %1$sDemo%2$s', 'super-product-filter'), '<a href="https://demo.hashthemes.com/super-woocommerce-product-filter/shop/" target="_blank">', '</a>');
                ?>
            </td>
            <td class="swpf-no"><i class="mdi-close"></i><?php esc_html_e('No', 'super-product-filter'); ?></td>
            <td class="swpf-yes"><i class="mdi-check"></i><?php esc_html_e('Yes', 'super-product-filter'); ?></td>
