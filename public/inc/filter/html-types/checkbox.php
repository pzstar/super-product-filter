                ...
                if ($all_terms) {
                    foreach ($all_terms as $key => $aterm) {
                        ...
                        if ($swpf_tax_show_count) {
                            $swpf_args = swpf_get_vars_query_args($current_filter_option, $settings, $tax_name, get_term($key)->slug);
            ...
            foreach ($terms as $key => $term) {
                ...
                if ($tax_name == 'product_visibility') {
                    ...
                    if (isset($current_filter_option['brand']) && !empty($current_filter_option['brand']) && is_array($current_filter_option['brand'])) {
                        $swpf_checked = in_array($term->slug, $current_filter_option['brand']) ? true : false;
                    }
                    ?>
                    <div class="swpf-filter-item">
                        <label class="swpf-filter-label">
