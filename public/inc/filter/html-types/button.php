    ...
    if ($terms) {
        foreach ($terms as $key => $term) {
            ...
            if ($tax_name == 'product_visibility') {
                ...
                <div class="swpf-filter-item">
                    <label>
                        <input type="checkbox" class="swpf-chkbox-term swpf-chkbox-term-<?php echo esc_attr($term->term_id); ?>" name="brands[]" data-termurl="<?php echo esc_url(get_term_link($term->term_id)); ?>" data-taxonomy="<?php echo esc_attr($term->taxonomy); ?>" data-termid="<?php echo esc_attr($term->term_id); ?>" value="<?php echo esc_attr($term->slug); ?>" <?php checked($checked, true); ?>>
