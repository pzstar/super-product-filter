        ...
        if ($terms) {
            foreach ($terms as $key => $term) {
                ...
                if ($tax_show_count) {
                    ...
                    $post_count_ckk = $term_cquery->post_count;
                    wp_reset_postdata();
                    $term_count = $tax_name == 'product_brand' ? swpf_get_brand_count($term->term_id) : $term->count;
                    $post_count = min($post_count, $post_count_ckk, $term_count);
                }
                ...
                if ($tax_name == 'product_visibility') {
                    ...
                    if (isset($current_filter_option['brands']) && !empty($current_filter_option['brands']) && is_array($current_filter_option['brands'])) {
                        $checked = in_array($term->slug, $current_filter_option['brands']) ? true : false;
                    }
                    ?>
                    <div class="swpf-filter-item">
                        <label class="swpf-filter-label">
                            <input type="radio" id="swpf-term-<?php echo esc_attr($term->term_id) ?>" class="swpf-radio-term swpf-radio-term-<?php echo esc_attr($term->term_id); ?>" name="brands" data-termurl="<?php echo esc_url(get_term_link($term->term_id)); ?>" data-taxonomy="<?php echo esc_attr($term->taxonomy); ?>" data-termid="<?php echo esc_attr($term->term_id); ?>" value="<?php echo esc_attr($term->slug); ?>" <?php checked($checked, true); ?>>
