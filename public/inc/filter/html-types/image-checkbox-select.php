...
<div class="swpf-filter-item-list swpf-checkbox-image-select-type">
    ...
    if ($swpf_tax_name == 'product_cat') {
        ?>
        <ul class="swpf-filter-product-category swpf-filter-product-category-image-checkbox <?php echo $swpf_settings['config']['indent_cat'] == 'on' ? 'swpf-indent-product-cat' : ''; ?>">
            <?php
            ...
            if ($swpf_all_terms) {
                foreach ($swpf_all_terms as $swpf_key => $swpf_aterm) {
                    ...
                    $swpf_term_preview_array[$swpf_key]['image'] = $swpf_aterm['term_image'];
                }
            }
                        ...
                        <li class="swpf-filter-item product_cat-<?php echo esc_attr($swpf_term->slug); ?>">
                            <label class="swpf-filter-label">
                                ...
                                <?php if ($swpf_settings['display_type'][$swpf_tax_name] == 'image') { ?>
                                    <span class="swpf-image-box"><span class="swpf-image-url" style="background-image: url(<?php echo esc_url($swpf_settings['terms_customize'][$swpf_tax_name][$swpf_term->term_id]['term_image']); ?>)"></span></span>
                ...
                if ($swpf_tax_name == 'product_visibility') {
                    ...
                    <div class="swpf-filter-item">
                        <label class="swpf-filter-label">
                            ...
                            <?php
                            if ($swpf_settings['display_type'][$swpf_tax_name] == 'image') {
                                ?>
                                <span class="swpf-image-box"><span class="swpf-image-url" style="background-image: url(<?php echo esc_url($swpf_settings['terms_customize'][$swpf_tax_name][$swpf_term->term_id]['term_image']); ?>)"></span></span>
                                <?php
                            } elseif ($swpf_settings['display_type'][$swpf_tax_name] == 'color') {
                                ?>
                                <span class="swpf-color-box" style="background: <?php echo esc_attr($swpf_settings['terms_customize'][$swpf_tax_name][$swpf_term->term_id]['term_color']); ?>"></span>
                                <?php
                            }
